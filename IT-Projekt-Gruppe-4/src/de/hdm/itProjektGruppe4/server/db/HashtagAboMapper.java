...
public class HashtagAboMapper {
	...
	public Hashtagabonnement findHashtagAbonnementByID(int id) 
		...
		try {
			...
			ResultSet rs = stmt.executeQuery(
					"SELECT * FROM Hashtagabonnements " + "WHERE hashtagAboID=" + id);
	...
	public Hashtagabonnement findHashtagAbonnementByAbonnementID(int id) 
			throws IllegalArgumentException {
		...
		try {
			 ...
			 */
			ResultSet rs = stmt.executeQuery(
					"SELECT * FROM Hashtagabonnements " + "WHERE abonnementID=" + id);
	...
	public ArrayList<Hashtagabonnement> findHashtagAbonnementByNutzerID(int id) throws IllegalArgumentException {
		...
		try {
			...
			ResultSet rs = stmt.executeQuery(
					"SELECT * FROM Hashtagabonnements " + "WHERE NutzerID=" + id);
