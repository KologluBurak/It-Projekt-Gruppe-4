...
public class NachrichtMapper {
	...
	/**
	 * Diese Methode erm̦glicht eine Akutalisierung des
	...
	/**
	 * Diese Methode erm̦glicht es alle Nachrichten aus der Datenbank in einer
	 * Liste auszugeben.
	 * 
	 * @return
	 */
	...
	/**
	 * Diese Methode erm̦glicht es alle Nachrichten einer Unterhaltung anhand
	...
	/**
	 * Diese Methode erm̦glicht es einen Nutzer anhand seiner ID das
	 * Auszugeben.
	 * 
	 * @param id
	 * @return
