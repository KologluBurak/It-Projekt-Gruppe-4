...
public class MessagingAdministrationImpl extends RemoteServiceServlet implements MessagingAdministration {
	 ...
	 */
	public ArrayList<Nachricht> getAlleNachrichtbyNutzer(Nutzer nutzer) throws IllegalArgumentException {
	...
	public void save(Abonnement abo) throws IllegalArgumentException {
