...
//		return unterhaltungMapper.insert(datum);
	...
	/**
	 * Ändern von Attributen einer Unterhaltung. 
	 */
	public Unterhaltung update(Unterhaltung unterhaltung){
		return this.unterhaltungMapper.update(unterhaltung);
	}
...
//		return this.hashtagAboMapper.findHashtagAbonnementByNutzer(nutzer);
	...
	public Unterhaltungsliste getByAbsender(Nutzer nutzer) 
			throws IllegalArgumentException {
		return this.unterhaltungslisteMapper.findByAbsender(nutzer);
	}
	...
	public Unterhaltungsliste getByEmpfaenger(Nutzer nutzer) 
			throws IllegalArgumentException {
		return this.unterhaltungslisteMapper.findByEmpfaenger(nutzer);
	}
