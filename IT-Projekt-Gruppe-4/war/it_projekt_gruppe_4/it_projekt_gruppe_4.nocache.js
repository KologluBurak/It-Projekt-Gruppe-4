...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "it_projekt_gruppe_4" because\n';
  ...
  $wnd.__gwt_activeModules['it_projekt_gruppe_4'] = {
    'moduleName' : 'it_projekt_gruppe_4',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/it_projekt_gruppe_4.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['it_projekt_gruppe_4'].superdevmode = true;

  var expectedSuffix = '/it_projekt_gruppe_4.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + it_projekt_gruppe_4 + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:it_projekt_gruppe_4';
  var devModeSessionKey = '__gwtDevModeSession:it_projekt_gruppe_4';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/it_projekt_gruppe_4/it_projekt_gruppe_4.nocache.js';
  ...
  $wnd.__gwt_activeModules['it_projekt_gruppe_4'].canRedirect = true;
  $wnd.__gwt_activeModules['it_projekt_gruppe_4'].superdevmode = true;
  ...
  css = (moduleIdx == 1 ? css : '') +
    ".gwt-DevModeModule-" + moduleIdx + ".gwt-DevModeCompiling div:before{" +
      "content:'COMPILING it_projekt_gruppe_4';" +
      "font-size:24px;" +
      "color:#d2d9ee;" +
    "}";
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/it_projekt_gruppe_4?user.agent=' + ua + '&_callback=' + callback;
